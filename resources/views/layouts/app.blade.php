           ...
           <div class="offcanvas-body d-flex flex-column p-0">
             ...
             <div class="flex-grow-1 overflow-auto">
                 <ul class="nav flex-column p-2 gap-1">
                   ...
                   <li class="nav-item">
                        <a class="nav-link d-flex align-items-center gap-3 px-3 py-2 rounded text-dark hover-bg-light" data-bs-toggle="collapse" href="#adminCollapse" role="button" aria-expanded="{{ request()->routeIs('books.add', 'books.updateView', 'books.delete', 'loans.active') ? 'true' : 'false' }}" aria-controls="adminCollapse">
                        ...
                        <div class="collapse {{ request()->routeIs('books.add', 'books.updateView', 'books.delete', 'loans.active') ? 'show' : '' }}" id="adminCollapse">
